...
sessionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, login, password, authenticateUser, _b, user, token, doctor;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _b = _c.sent(), user = _b.user, token = _b.token, doctor = _b.doctor;
                delete user.password;
                return [2 /*return*/, response.json({ user: user, token: token, doctor: doctor })];
        }
    });
}); });
