...
var ListAppointmentsByDoctorService = /** @class */ (function () {
    function ListAppointmentsByDoctorService() {
    }
    ListAppointmentsByDoctorService.prototype.execute = function (_a) {
        var date = _a.date, doctor = _a.doctor, limit = _a.limit;
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, appointmentRepository
                                ...
                                .leftJoin('patient.appointments', 'patient_appointments', 'patient_appointments.status  = :status', {
                                status: 4,
                            })
                                .leftJoin('appointment.doctor', 'doctor')
                                .innerJoin('doctor.user', 'user')
                                .where('appointment.date = :date', { date: date })
    ...
    return ListAppointmentsByDoctorService;
}());
exports.default = ListAppointmentsByDoctorService;
