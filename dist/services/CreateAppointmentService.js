...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        var date = _a.date, start_time = _a.start_time, status = _a.status, type = _a.type, doctor_id = _a.doctor_id, patient_id = _a.patient_id, clinic_id = _a.clinic_id;
        return __awaiter(this, void 0, void 0, function () {
            var appointmentRepository, appointment, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, appointmentRepository.save(appointment)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, appointment];
                    case 3:
                        error_1 = _b.sent();
                        throw new AppError_1.default('Error on save the appointmet', 500);
