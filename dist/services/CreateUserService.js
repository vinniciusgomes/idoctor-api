...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var name = _a.name, login = _a.login, password = _a.password, type = _a.type, clinic_id = _a.clinic_id;
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, hashedPassword, user, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _b = _c.sent();
                        throw new AppError_1.default('Error on save user');
